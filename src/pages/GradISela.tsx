          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                ...
                src="/lovable-uploads/2ced3733-39ac-4aad-9585-de411d7b8b6c.jpg"
              />
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-24">
            {detailedVillages.map((village, index) => (
              <motion.div
                key={village.name}
                ...
                className={`grid md:grid-cols-2 gap-12 items-center ${
                  village.reverse ? "md:grid-flow-dense" : ""
                }`}
              >
                ...
                <motion.div
                  initial={{ opacity: 0, x: village.reverse ? -30 : 30 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  <img
                    src={village.image}
                    alt={village.name}
                    className="rounded-lg shadow-lg w-full h-[350px] md:h-[400px] object-cover"
                  />
                  <div
                    className={`absolute -bottom-4 ${
                      village.reverse ? "-right-4" : "-left-4"
                    } w-20 h-20 bg-accent/30 rounded-lg -z-10`}
                  />
                </motion.div>
              </motion.div>
            ))}
      ...
      <section className="section-padding bg-cream">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {simpleVillages.map((village, index) => (
              <motion.div
                key={village.name}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
